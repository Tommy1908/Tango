...
def test_count_file():
    path = "excel_processing/test/excel_test.xlsx"
    expected_count = [{'hotel': 'AQ TAILORED SUITES - Hotel', 'address': 'MONTEVIDEO 937', 'count': 2}, {'hotel': 'ARC ARENALES - EDIFICIO', 'address': 'ARENALES 2644', 'count': 2}, {'hotel': 'BA ABASTO HOTEL - Hotel', 'address': 'Jean Jaures 896', 'count': 2}, {'hotel': 'BELIEVE - Hotel', 'address': 'CHILE 80', 'count': 10}, {'hotel': 'BROADWAY - Hotel', 'address': 'CORRIENTES 1173', 'count': 2}, {'hotel': 'DOLMEN - Hotel', 'address': 'SUIPACHA 1079', 'count': 6}, {'hotel': 'EL CONQUISTADOR - Hotel', 'address': 'SUIPACHA 948', 'count': 2}, {'hotel': 'LIBERTADOR HOTEL - Hotel', 'address': 'CORDOBA 690', 'count': 4}, {'hotel': 'NH CENTRO HISTORICO - Hotel', 'address': 'BOLIVAR 120', 'count': 4}, {'hotel': 'NOMA HOTEL - Hotel', 'address': 'RODRIGUEZ PEÑA 151', 'count': 2}, {'hotel': 'PARK ROYAL CITY BS AS - Hotel', 'address': 'SUIPACHA 1092', 'count': 2}, {'hotel': 'PASEO DE LA CISTERNA - EDIFICIO', 'address': 'MORENO 550', 'count': 2}]
